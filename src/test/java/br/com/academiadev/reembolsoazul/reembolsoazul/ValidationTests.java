...
public class ValidationTests {
	...
	public void emailValidationTest() {
		Assert.assertTrue(
				ValidationsHelper.emailValidation("bla@bla.com.br") == true &&
				...
				ValidationsHelper.emailValidation(null) == false &&
				ValidationsHelper.emailValidation("") == false
		);
	}
	...
	public void passwordFormatValidationTest() {
		Assert.assertTrue(
				ValidationsHelper.passwordFormatValidation("1aA+1234") == true &&
